...
/**
 * @defgroup ocrypto_ed448 EdDSA Ed448
 * @ingroup ocrypto_asym_sig
 * @{
 * @brief Ed448 algorithm, used for EdDSA without pre-hashing.
 *
...
#ifndef OCRYPTO_ED448_H
#define OCRYPTO_ED448_H
 ...
 */
void ocrypto_ed448_public_key(
    uint8_t pk[ocrypto_ed448_PUBLIC_KEY_BYTES],
    const uint8_t sk[ocrypto_ed448_SECRET_KEY_BYTES]);
 ...
 * @param      pk    Public key.
 */
void ocrypto_ed448_sign(
    uint8_t sig[ocrypto_ed448_BYTES],
    const uint8_t *m, size_t m_len,
    const uint8_t sk[ocrypto_ed448_SECRET_KEY_BYTES],
    const uint8_t pk[ocrypto_ed448_PUBLIC_KEY_BYTES]);
 ...
 * @retval -1 Otherwise.
 */
int ocrypto_ed448_verify(
    const uint8_t sig[ocrypto_ed448_BYTES],
    const uint8_t *m, size_t m_len,
    const uint8_t pk[ocrypto_ed448_PUBLIC_KEY_BYTES]);
