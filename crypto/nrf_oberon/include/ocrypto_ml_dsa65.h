...
typedef struct {
    ...
    int32_t c[256];
    int32_t s[256];
} ocrypto_ml_dsa65_ctx_s;

typedef struct {
    ocrypto_sha3_ctx sha3;
    int32_t t[256];
    int32_t u[6][256];
} ocrypto_ml_dsa65_ctx_m;
...
typedef struct {
    ...
    int32_t y[5][256];
    int32_t t0[6][256];
} ocrypto_ml_dsa65_ctx_f;

#if defined(OCRYPTO_ML_DSA_SMALL)
typedef ocrypto_ml_dsa65_ctx_s ocrypto_ml_dsa65_ctx;
#elif defined(OCRYPTO_ML_DSA_FAST)
typedef ocrypto_ml_dsa65_ctx_f ocrypto_ml_dsa65_ctx;
#else
typedef ocrypto_ml_dsa65_ctx_m ocrypto_ml_dsa65_ctx;
#endif


int ocrypto_ml_dsa65_key_pair_s(
    ocrypto_ml_dsa65_ctx_s *ctx,
    uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
    uint8_t pk[ocrypto_ml_dsa65_PK_SIZE],
    const uint8_t zeta[32]);
int ocrypto_ml_dsa65_key_pair_m(
    ocrypto_ml_dsa65_ctx_m *ctx,
    uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
    uint8_t pk[ocrypto_ml_dsa65_PK_SIZE],
    const uint8_t zeta[32]);

int ocrypto_ml_dsa65_sign_s(
    ocrypto_ml_dsa65_ctx_s *ctx,
...
int ocrypto_ml_dsa65_sign_m(
    ...
    const uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
    const uint8_t rnd[32]);
int ocrypto_ml_dsa65_sign_f(
    ocrypto_ml_dsa65_ctx_f *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *m, size_t mlen,
    const uint8_t *ctx_str, size_t ctx_len,
    const uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
...
int ocrypto_ml_dsa65_sign_hash_s(
    ocrypto_ml_dsa65_ctx_s *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    ...
    const uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
    const uint8_t rnd[32]);
int ocrypto_ml_dsa65_sign_hash_m(
    ocrypto_ml_dsa65_ctx_m *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
    ...
    const uint8_t sk[ocrypto_ml_dsa65_SK_SIZE],
    const uint8_t rnd[32]);
int ocrypto_ml_dsa65_sign_hash_f(
    ocrypto_ml_dsa65_ctx_f *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
...
int ocrypto_ml_dsa65_verify_hash_s(
    ocrypto_ml_dsa65_ctx_s *ctx,
    const uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
    const uint8_t *ctx_str, size_t ctx_len,
    const uint8_t pk[ocrypto_ml_dsa65_PK_SIZE]);
int ocrypto_ml_dsa65_verify_hash_m(
    ocrypto_ml_dsa65_ctx_m *ctx,
    const uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
 ...
 */
static inline int ocrypto_ml_dsa65_key_pair(
...
{
#if defined(OCRYPTO_ML_DSA_SMALL)
    return ocrypto_ml_dsa65_key_pair_s(ctx, sk, pk, zeta);
#else
    return ocrypto_ml_dsa65_key_pair_m((ocrypto_ml_dsa65_ctx_m*)ctx, sk, pk, zeta);
#endif
}
 ...
 * @return 0 on success, non-zero on failure.
 */
static inline int ocrypto_ml_dsa65_sign(
    ocrypto_ml_dsa65_ctx *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *m, size_t mlen,
    const uint8_t *ctx_str, size_t ctx_len,
...
{
#if defined(OCRYPTO_ML_DSA_SMALL)
    return ocrypto_ml_dsa65_sign_s(ctx, sig, m, mlen, ctx_str, ctx_len, sk, rnd);
#elif defined(OCRYPTO_ML_DSA_FAST)
    return ocrypto_ml_dsa65_sign_f(ctx, sig, m, mlen, ctx_str, ctx_len, sk, rnd);
#else
    return ocrypto_ml_dsa65_sign_m(ctx, sig, m, mlen, ctx_str, ctx_len, sk, rnd);
#endif
}
 ...
 * @return 0 on success, non-zero on failure.
 */
static inline int ocrypto_ml_dsa65_sign_hash(
    ocrypto_ml_dsa65_ctx *ctx,
    uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
...
{
#if defined(OCRYPTO_ML_DSA_SMALL)
    return ocrypto_ml_dsa65_sign_hash_s(ctx, sig, hash, hash_len, oid, ctx_str, ctx_len, sk, rnd);
#elif defined(OCRYPTO_ML_DSA_FAST)
    return ocrypto_ml_dsa65_sign_hash_f(ctx, sig, hash, hash_len, oid, ctx_str, ctx_len, sk, rnd);
#else
    return ocrypto_ml_dsa65_sign_hash_m(ctx, sig, hash, hash_len, oid, ctx_str, ctx_len, sk, rnd);
#endif
}
 ...
 * @return 0 on success, non-zero on failure.
 */
static inline int ocrypto_ml_dsa65_verify(
    ocrypto_ml_dsa65_ctx *ctx,
    const uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *m, size_t mlen,
    const uint8_t *ctx_str, size_t ctx_len,
...
{
#if defined(OCRYPTO_ML_DSA_SMALL)
    return ocrypto_ml_dsa65_verify_s(ctx, sig, m, mlen, ctx_str, ctx_len, pk);
#else
    return ocrypto_ml_dsa65_verify_m((ocrypto_ml_dsa65_ctx_m*)ctx, sig, m, mlen, ctx_str, ctx_len, pk);
#endif
}
 ...
 * @return 0 on success, non-zero on failure.
 */
static inline int ocrypto_ml_dsa65_verify_hash(
    ocrypto_ml_dsa65_ctx *ctx,
    const uint8_t sig[ocrypto_ml_dsa65_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
...
{
#if defined(OCRYPTO_ML_DSA_SMALL)
    return ocrypto_ml_dsa65_verify_hash_s(ctx, sig, hash, hash_len, oid, ctx_str, ctx_len, pk);
#else
    return ocrypto_ml_dsa65_verify_hash_m((ocrypto_ml_dsa65_ctx_m*)ctx, sig, hash, hash_len, oid, ctx_str, ctx_len, pk);
#endif
}
