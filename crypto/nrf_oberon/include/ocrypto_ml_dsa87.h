 ...
 * @return 0 on success, non-zero on failure.
 */
int ocrypto_ml_dsa87_sign_internal(
    ocrypto_ml_dsa87_ctx *ctx,
 ...
 * @return 0 on success, non-zero on failure.
 */
int ocrypto_ml_dsa87_sign_hash(
    ocrypto_ml_dsa87_ctx *ctx,
    uint8_t sig[ocrypto_ml_dsa87_SIG_SIZE],
 ...
 * @return 0 on success, non-zero on failure.
 */
int ocrypto_ml_dsa87_verify_internal(
    ocrypto_ml_dsa87_ctx *ctx,
 ...
 * @return 0 on success, non-zero on failure.
 */
int ocrypto_ml_dsa87_verify_hash(
    ocrypto_ml_dsa87_ctx *ctx,
    const uint8_t sig[ocrypto_ml_dsa87_SIG_SIZE],
    const uint8_t *hash, size_t hash_len,
    const uint8_t oid[11],
