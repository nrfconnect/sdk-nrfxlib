...
/**
 * \brief Internal ECDSA sign operation
 *
 * \param[in]  attributes        Attributes of the key to use
 ...
 * \param[in]  alg               Algorithm to use
 * \param[in]  input             Data to sign buffer
 * \param[in]  input_len         Size in bytes of the data to sign
 * \param[out] signature         Buffer to hold the signature data
 * \param[in]  signature_size    Size in bytes of the signature buffer
 * \param[out] signature_length  Size in bytes of the signature
 * \param[in]  do_hashing        Whether to hash the input before signing
 *
...
/**
 * \brief Internal RSA sign operation
 *
 * \param[in]  attributes        Attributes of the key to use
 * \param[in]  key_buffer        Buffer holding the private key
 * \param[in]  key_length        Size in bytes of the key
 ...
 * \retval  PSA_SUCCESS on success. Error code from psa_status_t on failure
 */
psa_status_t cc3xx_internal_rsa_sign(
...
/**
 * \brief Internal ECDSA verify operation
 *
 * \param[in]  attributes        Attributes of the key to use
 * \param[in]  key               Buffer holding the public key
 * \param[in]  key_length        Size in bytes of the key
 * \param[in]  alg               Algorithm to use
 * \param[in]  input             Data to verify buffer
 * \param[in]  input_len         Size in bytes of the data to verify
 * \param[in]  signature         Signature to verify
 * \param[in]  signature_length  Size in bytes of the signature
 * \param[in]  do_hashing        Whether to hash the input before verifying
 *
 * \retval  PSA_SUCCESS on success. Error code from psa_status_t on failure
 */
psa_status_t cc3xx_internal_ecdsa_verify(
    const psa_key_attributes_t *attributes,
    const uint8_t *key, size_t key_length,
    psa_algorithm_t alg,
...
/**
 * \brief Internal RSA verify operation
 *
 * \param[in]  attributes        Attributes of the key to use
 * \param[in]  key_buffer        Buffer holding the public key
 * \param[in]  key_length        Size in bytes of the key
 * \param[in]  alg               Algorithm to use
 * \param[in]  input             Data to verify buffer
 * \param[in]  input_length      Size in bytes of the data to verify
 * \param[in]  signature         Signature to verify
 * \param[in]  signature_length  Size in bytes of the signature
 * \param[in]  do_hashing        Whether to hash the input before verifying
 *
 * \retval  PSA_SUCCESS on success. Error code from psa_status_t on failure
 */
psa_status_t cc3xx_internal_rsa_verify(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer,
    size_t key_length, psa_algorithm_t alg,
    const uint8_t *input,
...
/**
 * \brief Internal EdDSA sign operation
 *
 * \param[in]  attributes        Attributes of the key to use
 * \param[in]  key_buffer        Buffer holding the private key
 * \param[in]  key_length        Size in bytes of the key
 ...
 * \retval  PSA_SUCCESS on success. Error code from psa_status_t on failure
 */
psa_status_t cc3xx_internal_eddsa_sign(const psa_key_attributes_t *attributes,
                                       const uint8_t *key_buffer,
                                       size_t key_length, psa_algorithm_t alg,
...
/**
 * \brief Internal EdDSA verify operation
 *
 * \param[in]  attributes        Attributes of the key to use
 * \param[in]  key               Buffer holding the public key
 * \param[in]  key_length        Size in bytes of the key
