...
nrf_cc3xx_mbedcrypto - 0.9.23
*****************************

New version of the runtime library with the following bug fixes and improvements:

* Improved error reporting for the PSA driver for GCM.
* Fixed an issue in the GCM implementation which resulted in incorrect authentication tag generation when multiple calls to ``psa_aead_update_ad`` were made.
...
* nrf_cc312_mbedcrypto, nRF5340 variants:
  ...
  * :file:`crypto/nrf_cc312_mbedcrypto/lib/cortex-m33/**/libnrf_cc312_psa_crypto_0.9.23.a`
  * :file:`crypto/nrf_cc312_mbedcrypto/lib/cortex-m33/**/libnrf_cc312_core_0.9.23.a`

* nrf_cc310_mbedcrypto, nRF91 Series variants:

  * :file:`crypto/nrf_cc310_mbedcrypto/lib/cortex-m33/**/libnrf_cc310_psa_crypto_0.9.23.a`
  * :file:`crypto/nrf_cc310_mbedcrypto/lib/cortex-m33/**/libnrf_cc310_core_0.9.23.a`

* nrf_cc310_mbedcrypto, nRF52840 variants:

  * :file:`crypto/nrf_cc310_mbedcrypto/lib/cortex-m4/**/libnrf_cc310_psa_crypto_0.9.23.a`
  * :file:`crypto/nrf_cc310_mbedcrypto/lib/cortex-m4/**/libnrf_cc310_core_0.9.23.a`
...
* Changed the PSA key management, key agreement, and asymmetric signing implementations to open-source format.
* Fixed issues with key generation error codes for Edwards and Montgomery curves to consistently return ``PSA_ERROR_NOT_SUPPORTED``.
...
* Removed support for generating symmetric keys with the PSA Crypto driver.
  The Oberon PSA Crypto core now provides this functionality using random numbers from CryptoCell.
