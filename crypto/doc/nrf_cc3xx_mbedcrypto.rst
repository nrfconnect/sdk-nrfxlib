...
Starting from version 0.9.13, the nrf_cc3xx_mbedcrypto library contains a companion nrf_cc3xx_platform library that provides PSA driver integration for select features.
