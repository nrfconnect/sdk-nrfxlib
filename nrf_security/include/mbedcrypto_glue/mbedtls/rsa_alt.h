...
#define CC310_MBEDTLS_RSA_CONTEXT_WORDS 52
#define VANILLA_MBEDTLS_RSA_CONTEXT_WORDS 43
...
typedef struct mbedtls_rsa_context
{
    ...
    union
    {
        ...
        uint32_t buffer_cc310[CC310_MBEDTLS_RSA_CONTEXT_WORDS];
#endif
#if defined(CONFIG_VANILLA_MBEDTLS_RSA_C)
        uint32_t buffer_vanilla_mbedtls[VANILLA_MBEDTLS_RSA_CONTEXT_WORDS];
#endif
        uint32_t dummy;
    } buffer;
} mbedtls_rsa_context;
