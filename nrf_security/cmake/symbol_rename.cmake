...
function(library_redefine_symbols backend template)
  ...
  target_link_libraries(mbedcrypto_glue 
                        INTERFACE mbedcrypto_${MBEDTLS_BACKEND_PREFIX}_backend)

  if("${MBEDTLS_BACKEND_PREFIX}" STREQUAL "cc310")
    target_link_libraries(mbedcrypto_${MBEDTLS_BACKEND_PREFIX}_backend
                          INTERFACE mbedcrypto_vanilla_backend)
  endif()
