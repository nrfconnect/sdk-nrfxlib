...
macro(keep_config_test_alt mbedtls_config backend_name)
  if(CONFIG_${backend_name}_${mbedtls_config}_C
     OR ${mbedtls_config}_ALT)
    set(KEEP_${mbedtls_config}_C "#")
  endif()
endmacro()
...
function(library_redefine_symbols backend template)
  ...
  keep_config_test_alt("MBEDTLS_SHA1"             ${BACKEND_NAME})
  keep_config_test_alt("MBEDTLS_SHA256"           ${BACKEND_NAME})
  keep_config_test_alt("MBEDTLS_RSA"              ${BACKEND_NAME})
