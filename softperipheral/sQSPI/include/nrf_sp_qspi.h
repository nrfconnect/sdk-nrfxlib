...
typedef struct
{
    ...
    __IOM uint32_t DPPIMAP;                                                 /*!< (@ 0x00000010) Task to handler map and DPPI subscription permissions */
} NRF_QSPI_SPSYNC_Type;                                                     /*!< Size = 20 (0x014)                                                    */
...
/* QSPI_SPSYNC_DPPIMAP: Task to handler map and DPPI subscription permissions */
  #define QSPI_SPSYNC_DPPIMAP_ResetValue (0x03204015UL)                     /*!< Reset value of DPPIMAP register.  */

/* VALID @Bits 0..3 : Marks this register as carrying a map the soft peripheral should apply */
  #define QSPI_SPSYNC_DPPIMAP_VALID_Pos   (0UL)
  #define QSPI_SPSYNC_DPPIMAP_VALID_Msk   (0xFUL << QSPI_SPSYNC_DPPIMAP_VALID_Pos)
  #define QSPI_SPSYNC_DPPIMAP_VALID_Valid (0x5UL)                           /*!< Register contents are a valid map */

/* ROLE0 @Bits 4..7 : Handler invoked by task entry 0 (DPPI channel 0) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_Pos    (4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE0_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE0_STOP   (0x4UL)

/* ROLE1 @Bits 8..11 : Handler invoked by task entry 1 (DPPI channel 1) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_Pos    (8UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE1_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE1_STOP   (0x4UL)

/* ROLE2 @Bits 12..15 : Handler invoked by task entry 2 (DPPI channel 2) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_Pos    (12UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE2_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE2_STOP   (0x4UL)

/* ROLE3 @Bits 16..19 : Handler invoked by task entry 3 (DPPI channel 3) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_Pos    (16UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE3_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE3_STOP   (0x4UL)

/* ROLE4 @Bits 20..23 : Handler invoked by task entry 4 (no DPPI channel) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_Pos    (20UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE4_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE4_STOP   (0x4UL)

/* ROLE5 @Bits 24..27 : Handler invoked by task entry 5 (no DPPI channel) */
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_Pos    (24UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_Msk    (0xFUL << QSPI_SPSYNC_DPPIMAP_ROLE5_Pos)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_Min    (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_Max    (0x4UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_NONE   (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_DPPI0  (0x1UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_CONFIG (0x2UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_ACTION (0x3UL)
  #define QSPI_SPSYNC_DPPIMAP_ROLE5_STOP   (0x4UL)

/* PERMIT @Bits 28..31 : Per slot permission to subscribe the DPPI channel, bit n for entry n */
  #define QSPI_SPSYNC_DPPIMAP_PERMIT_Pos (28UL)
  #define QSPI_SPSYNC_DPPIMAP_PERMIT_Msk (0xFUL << QSPI_SPSYNC_DPPIMAP_PERMIT_Pos)
  #define QSPI_SPSYNC_DPPIMAP_PERMIT_Min (0x0UL)
  #define QSPI_SPSYNC_DPPIMAP_PERMIT_Max (0xFUL)
