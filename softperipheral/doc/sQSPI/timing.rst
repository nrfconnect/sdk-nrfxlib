...
The following timing diagrams provide a visual reference for how the parameters t\ :sub:`DOV` and t\ :sub:`SDI` relate to SCLK, SDIO represents the data line(s):
