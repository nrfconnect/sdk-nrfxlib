...
typedef enum
{
    ...
    NRF_CAN_PARSING_DPPI     = SP_CAN_CONFIG_PARSING_REGGROUP_Dppi,
} nrf_can_parsing_t;
...
NRF_STATIC_INLINE void nrf_can_set_parsing_dppi(NRF_CAN_Type * p_reg);
...
NRF_STATIC_INLINE void nrf_can_set_parsing_dppi(NRF_CAN_Type * p_reg)
{
    p_reg->CONFIG.PARSING = NRF_CAN_PARSING_DPPI;
}
