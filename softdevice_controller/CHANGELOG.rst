...
* The HCI VS DTM sub-command Test End. It is functionally identical to the standard HCI_LE_Test_End command, except that it returns the number of packets transmitted when used to end a transmitter test.
