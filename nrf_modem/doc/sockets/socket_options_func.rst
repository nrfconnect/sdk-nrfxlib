...
The details for each socket option are described in the API documentation, notably in the :ref:`nrf_socket_generic_options_api` and :ref:`nrf_socket_tls_api` sections.
