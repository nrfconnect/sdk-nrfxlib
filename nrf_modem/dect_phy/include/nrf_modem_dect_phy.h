 ...
 */
#ifndef NRF_MODEM_DECT_PHY_H
#define NRF_MODEM_DECT_PHY_H
 ...
 *
 * See 6.2.1 in @ref DECT-ETSI "DECT-2020 NR Part 4".
 */
...
struct nrf_modem_dect_phy_link_id {
	 ...
	 *
	 * Big endian encoding.
	 * Used for transmitter identity in @ref DECT-ETSI "DECT-2020 NR Part 4".
	 */
...
struct nrf_modem_dect_phy_rx_filter {
	 ...
	 *
	 * See 6.2.1 and 4.2.3.1 in @ref DECT-ETSI "DECT-2020 NR Part 4".
	 */
	uint8_t short_network_id;
	/**
	 ...
	 *
	 * See 6.2.1 and 4.2.3.3 in @ref DECT-ETSI "DECT-2020 NR Part 4".
	 */
...
struct nrf_modem_dect_phy_rx_pcc_status {
	 ...
	 *
	 * Values are dBm values with 0.5 dBm resolution (Q14.1).
	 *
	 * See 8.3 in @ref DECT-ETSI "DECT-2020 NR Part 2".
	 */
	int16_t rssi_2;
	/**
	 ...
	 *
	 * See 8.4 in @ref DECT-ETSI "DECT-2020 NR Part 2".
	 */
	int16_t snr;
};
...
struct nrf_modem_dect_phy_rx_params {
	 ...
	 *
	 * See 5.4.2 of @ref DECT-ETSI "DECT-2020 NR Part 2".
	 */
	uint16_t carrier;
	/**
...
struct nrf_modem_dect_phy_tx_params {
	 ...
	 * @brief Physical layer control field type.
	 *
	 * Valid values are 0 and 1 corresponding Type 1 and Type 2 6.2.1 of [2], respectively.
	 */
	uint8_t phy_type;
	/**
	 ...
	 *
	 * See 5.1.2 of @ref DECT-ETSI "DECT-2020 NR Part 4".
	 */
 ...
 *
 * @note
 * Only RX operations can be stoppped.
 *
