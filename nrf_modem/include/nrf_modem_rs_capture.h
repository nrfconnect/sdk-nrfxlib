...
struct nrf_modem_rs_capture_event_data {
	 ...
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_SUCCESS Success.
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_NO_MEM No memory for sample.
	 *
	 * Possible values for @ref NRF_MODEM_RS_CAPTURE_EVT_CELL_STATUS event:
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_CELL_AVAILABLE: Cell available.
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_NO_CELL: Cell lost.
	 *
	 * Possible values for @ref NRF_MODEM_RS_CAPTURE_EVT_ABORT event:
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_NO_CELL: Cell lost.
	 *   - @ref NRF_MODEM_RS_CAPTURE_STATUS_STOPPED: Session duration exceeded or
 ...
 * @retval -NRF_ENOMEM There is not enough shared memory for this request.
 * @retval -NRF_ESHUTDOWN The modem was shut down.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_NO_CELL Cell not found.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_BUSY Resources not available or session already started.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_NOT_SUPPORTED Capture not supported in current
 *              LTE system.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_TIMEOUT Timeout.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_STOPPED Stop requested during start.
 */
 ...
 * @retval -NRF_ENOMEM There is not enough shared memory for this request.
 * @retval -NRF_ESHUTDOWN The modem was shut down.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_NOT_ACTIVE Session not active.
 * @retval @ref NRF_MODEM_RS_CAPTURE_STATUS_NOT_SUPPORTED Parameter values not supported.
 */
