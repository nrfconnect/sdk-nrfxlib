...
/**
 * @file nrf_modem_dect_mac.h
 *
 * @defgroup nrf_modem_dect_mac DECT MAC interface
 * @{
 * @brief Application interface for DECT MAC layer.
 *
...
#ifndef NRF_MODEM_DECT_MAC_H
#define NRF_MODEM_DECT_MAC_H
...
struct nrf_modem_dect_mac_neighbor_info_cb_params {
	...
	/** Neighbor status information, valid only neighbor is associated */
...
struct nrf_modem_dect_mac_association_ntf_cb_params {
	...
	/** Chosen method to deliver data to neighbor, valid only if status is SUCCESS. */
 ...
 *
 * @param op_cb Application callbacks to operation complete notifications.
 * @param ntf_cb Application callbacks to indication event notifications.
 *
 * @retval 0 On success.
...
struct nrf_modem_dect_mac_cluster_config {
	 ...
	 * to accepted associations with the Association Response.
	 */
	struct nrf_modem_dect_mac_ipv6_address_config_t ipv6_config;
};
