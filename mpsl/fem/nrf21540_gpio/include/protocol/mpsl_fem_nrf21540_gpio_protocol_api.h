...
/** @brief Bit number of @ref mpsl_fem_pa_power_control_t::private_setting holding MODE pin state. */
#define MPSL_FEM_NRF21540_GPIO_PA_POWER_CONTROL_MODE_BITNO    (0)

/** @brief Bit mask of @ref mpsl_fem_pa_power_control_t::private_setting for holding MODE pin state. */
#define MPSL_FEM_NRF21540_GPIO_PA_POWER_CONTROL_MODE_MSK      (1U << MPSL_FEM_NRF21540_GPIO_PA_POWER_CONTROL_MODE_BITNO)

/** @brief Bit field value of @ref mpsl_fem_pa_power_control_t::private_setting for controlling MODE pin state to use POUTA power setting. */
#define MPSL_FEM_NRF21540_GPIO_PA_POWER_CONTROL_MODE_POUTA    (0U << MPSL_FEM_NRF21540_GPIO_PA_POWER_CONTROL_MODE_BITNO)

/** @brief Bit field value of @ref mpsl_fem_pa_power_control_t::private_setting for controlling MODE pin state to use POUTB power setting. */
