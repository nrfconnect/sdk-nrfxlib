...
This page describes how to integrate the Multi-Protocol Service Layer (MPSL) into an application.
...
The image below shows how the MPSL integrates in an RTOS-free environment.

.. figure:: pic/Architecture_Without_RTOS.svg

The image below shows how the the MPSL integrates with an RTOS.
